...
import stripe
stripe.api_key = "sk_test_ieC1NVzyI7aQLqhlk4qFd3pA001kPqBlMt"
...
class BillingProfileManager(models.Manager):
    def new_or_get(self,request):
        ...
        if user.is_authenticated:
            ...
            print("guest billingviews",guest_email_obj)
...
class BillingProfile(models.Model):
    ...
    def get_payment_method_url(self):
        ...
        #return "billing/payment-method/" the both didnt work i dont know why
        #return HttpResponseRedirect("billing/payment-method/")
...
def post_save_card_receiver(sender, instance, created, *args, **kwargs):
    if instance.default:
        ...
        qs = Card.objects.filter(billing_profile=billing_profile).exclude(pk=instance.pk) #instance is Card
        qs.update(default=False)
        print("cart models billing", instance)
